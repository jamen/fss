...
Value.protounit.compareUnits = function(otherValue){
...
Value.protounit._operation = function(otherValue, callback){
...
Value.protounit.plus =
Value.protounit.add = function(otherValue){
  return this._operation(otherValue, (otherValue) => this.val + otherValue.val);
};

Value.protounit.minus =
Value.protounit.subtract = function(otherValue){
  return this._operation(otherValue, (otherValue) => this.val - otherValue.val);
};

Value.protounit.times =
Value.protounit.multiply = function(otherValue) {
  return this._operation(otherValue, (otherValue) => this.val * otherValue.val);
};

Value.protounit.divide = function(otherValue){
  return this._operation(otherValue, (otherValue) => this.val / otherValue.val);
};

Value.protounit.equals =
Value.protounit.compare = function(otherValue){
  return this.compareUnits(otherValue) && (this.val === otherValue.val);
};

Value.protounit.convert = function(unit, options){
  if (!options) options = {};
...
Value.protounit.serialize = function(){
